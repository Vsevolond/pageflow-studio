...
extension HStackBlock {
    ...
    enum Modifier: ASTNode {
        ...
        case stackAlignment(HAlignmentModifier)
        ...
        var range: NSRange {
            ...
            case .stackAlignment(let hAlignmentModifier):
                hAlignmentModifier.range
            }
        }
        ...
        func validate(with storage: ASTStorage) throws(ASTError) {
            ...
            case .stackAlignment(let hAlignmentModifier):
                try hAlignmentModifier.validate(with: storage)
            }
        }
    }
}
...
extension HStackBlock {
    ...
    struct Parameters {
        ...
        init(
            ...
            stackAlignment: VerticalAlignment = .center,
    ...
    var parameters: Parameters {
        ...
        for modifier in modifiers {
            ...
            case .stackAlignment(let hAlignmentModifier):
                parameters.stackAlignment = hAlignmentModifier.rawValue
            }
        }
